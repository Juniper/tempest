...
export OS_AUTH_URL=${KEYSTONE_SERVICE_PROTOCOL}://${KEYSTONE_SERVICE_HOST}:5000/v3
...
export HTTP_IMAGE_PATH=${HTTP_IMAGE_PATH:-10.204.217.58}
export HTTP_IMAGE_PATH="http://${HTTP_IMAGE_PATH}/images/cirros/cirros-0.3.5-x86_64-disk.img"
